...
If you operate a compatible hosted plan normalizer, configure the local skill with:
...
If the hosted normalizer is unavailable or misconfigured, the public/community
edition fails fast during planning. It does not generate a local fallback
draft.
